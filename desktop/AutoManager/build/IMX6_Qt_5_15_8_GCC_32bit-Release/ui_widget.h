...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        listWidget_left = new QListWidget(Widget);
        listWidget_left->setObjectName(QString::fromUtf8("listWidget_left"));
        listWidget_left->setGeometry(QRect(0, 0, 400, 480));
        listWidget_right = new QListWidget(Widget);
        listWidget_right->setObjectName(QString::fromUtf8("listWidget_right"));
        listWidget_right->setGeometry(QRect(400, 0, 400, 480));
